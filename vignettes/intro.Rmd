...
You can find a working example [here](https://github.com/rstudio/tfhub/tree/main/vignettes/examples/feature_column.R).
...
An example can be found [here](https://github.com/rstudio/tfhub/tree/main/vignettes/examples/recipes.R).
